...
<body>
    ...
    <div class="white-box">
        ...
        if ($result->num_rows > 0) {
            echo "<table>";
            echo "<tr><th>Name</th><th>Location Stored</th><th>Notes</th><th>Expiration Date</th><th>Shelf Life</th><th>Timer</th><th>Edit</th><th>Delete</th></tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='editFruitsVegetables.php?id=" . $row["foodID"] . "' class='edit-button'>Edit</a></td>";
                echo "<td><a href='deleteFruitsVegetables.php?id=" . $row["foodID"] . "' class='delete-button'>Delete</a></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
    ...
    <a href="/PROJECTS/FOODWEB/detailsFruitsVegetables.php" class="no-decoration">
