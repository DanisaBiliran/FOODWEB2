...
<body>
    ...
    <div class="white-box">
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<td><a href='editgrainscereals.php?id=" . $row["foodID"] . "' class='edit-button'>Edit</a></td>";
              echo "<td><a href='deletegrainscereals.php?id=" . $row["foodID"] . "' class='delete-button'>Delete</a></td>";
              echo "</tr>";
          }
          echo "</table>";
      } else {
    ...
    <a href="/PROJECTS/FOODWEB/GRAINSCEREALS/detailsgrainscereals.php" class="no-decoration">
